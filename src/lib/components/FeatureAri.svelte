  ...
  <div class="container-custom">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
         ...
         <h3 class="font-bold text-gray-900 mb-2">Trained on your knowledge</h3>
         <p class="text-sm text-gray-500">Iris AI learns from your past RFPs, product docs, case studies, and verified company information for accurate responses.</p>
      </div>

      <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
         <div class="h-32 mb-6 bg-white rounded border border-gray-100 p-4 flex items-center justify-center gap-2">
             <div class="px-2 py-1 border border-green-200 bg-green-50 text-green-700 text-[10px] rounded">SOC 2 Verified</div>
             <div class="px-2 py-1 border border-gray-200 text-gray-500 text-[10px] rounded">95% Accuracy</div>
         </div>
         <h3 class="font-bold text-gray-900 mb-2">Enterprise-grade security</h3>
         <p class="text-sm text-gray-500">SOC 2 compliant with hallucination-free AI. Every response is traceable to verified sources in your knowledge base.</p>
      </div>

      <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
         <div class="h-32 mb-6 bg-white rounded border border-gray-100 p-4 flex items-center justify-center">
             <div class="flex items-center gap-2">
                 <div class="w-8 h-8 rounded-full border-2 border-green-500 flex items-center justify-center text-green-500 font-bold text-xs">60%</div>
                 <div class="text-xs font-bold text-gray-700">Time saved</div>
             </div>
         </div>
         <h3 class="font-bold text-gray-900 mb-2">Focus on winning deals</h3>
         <p class="text-sm text-gray-500">Sales teams reclaim weeks of manual work. Spend time on strategy and relationships while Iris handles RFP drafting.</p>
      </div>
    </div>
  </div>
</section>
